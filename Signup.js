...
export default class Signup extends Component {
    ...
    buttonpress() {
        ...
        var user = firebase.auth().createUserWithEmailAndPassword (email, password).catch (function (error) {
            ...
            var myUserAccInfo = firebase.auth().currentUser;
            console.log(JSON.stringify(myUserAccInfo));
            ...
            var myJson = {
              ...
              body: JSON.stringify({
                Message: "sending new User",
                myUser: myUserAccInfo
              })
            }

            // this.postUserData(curr);
            fetch('https://space-ucsc.herokuapp.com/createUser', myJson)
            .then((response) => response.json())
            .then((responseJson) => {
              console.log("id1: ", responseJson.testid1);
              console.log("id2: ", responseJson.testid2);
            ...
            alert("user email"+myUserAccInfo.email);
        });
    }
